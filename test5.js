...
function initMap() {
var dharamshala = {lat:32.2190, lng:76.3234};
var map = new google.maps.Map(
  document.getElementById('map'), {zoom: 10, center: dharamshala});
var marker = new google.maps.Marker({position: dharamshala, map: map});
}
